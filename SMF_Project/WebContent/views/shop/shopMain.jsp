...
<%--     <jsp:include page="/views/main/menubar_shop.jsp" /> --%>
    <div>
        ...
        <div id="category">
            <ul id="categoryUl">
                <li class="categoryLi cat1">전체</li>
                <li class="categoryLi cat2">럭셔리</li>
                        ...
                        <div class="filterCheck" id="filterCheck1" style="display: none;">
                            <ul class="filterCheckUl">                    
                                <li class="menu">
                                    ...
                                    <div>
                                        <ul id="columnMenu">
	                                        <li class="menu menu3 columnMenu">
			                                    <input type="checkbox" name="size" id="215" value="215"><label for="215" class="filterText">215</label><br>
			                                </li> 
			                                <li class="menu menu3 columnMenu">
			                                    <input type="checkbox" name="size" id="215" value="215"><label for="215" class="filterText">215</label><br>
			                                </li>
