     ...
     $(function(){
            ...
            $(".rightbox").on('click', function() {
                    ...
                    $.ajax({
                     ...
                     // $('.itemListboxList').empty();
                            var str = '';
                     str += '<section class="container2">' 
                            $(data).each(function(index, item){
                        // 현재 뿌려주는 아이템이 카테고리인지 아닌지도 확인필요
                        // 카테고리라면 이벤트 추가하는 부분만 안되게끔하기
                     ...
                     // 1. 페이지 첫 로딩시 드래그앤 드랍 이벤트는 실행되면 안됨
                     // 2. 카테고리 클릭시 드래그앤 드랍 이벤트를 새롭게 추가한 div요소에 별개로 부여하기
                     // 3. 
