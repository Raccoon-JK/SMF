...
<link rel="stylesheet"
	href="<%=contextPath%>/views/main/css/menu_style.css" type="text/css">
		...
		<div class="header_box">
			...
			<div class="header_main">
				<div class="main_inner">
					<a href="<%=contextPath%>"><img id="main_logo"
						src="${pageContext.request.contextPath}/resources/main/logo.png"></a>
				</div>
				<div class="gnb_area">
					<nav class="gnb">
						<ul class="gnb_list">
							<li><a href="<%=contextPath%>/dressroomMain.me">DRESS
									ROOM</a></li>
							<li><a href="<%=contextPath%>/mypagemain.me">MY</a></li>
							<li><button class="btnFind" type="submit" name="btnFind">
									<img id="search"
										src="<%=contextPath%>/resources/main/search_icon.png">
								</button></li>
						</ul>
					</nav>
				</div>
