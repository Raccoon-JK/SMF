  ...
  <body>
    ...
    <content>
      <div class="ct-btncontainer">
        ...
        <button type="button" class="btn btn-white">백팩</button>
        <button type="button" class="btn btn-white">샤넬</button>
        <button type="button" class="btn btn-white">미니백</button>
        <button type="button" class="btn btn-white">셀린느</button>
        <button type="button" class="btn btn-white">에코백</button>
        <button type="button" class="btn btn-white">코스</button>
