...
<title>구해줘 패션</title>
    ...
    <link rel="stylesheet" href="resources/style/css/category.css" />
  </head>
  <body>
    ...
    <content>
      <div class="ct-btncontainer">
        ...
        <button type="button" class="btn btn-white">발렌시아가</button>
        <button type="button" class="btn btn-white">루이비통</button>
        <button type="button" class="btn btn-white">구찌</button>
        <button type="button" class="btn btn-white">샤넬</button>
        <button type="button" class="btn btn-white">프라다</button>
        <button type="button" class="btn btn-white">롤렉스</button>
        <button type="button" class="btn btn-white">에르메스</button>
      </div>
