            ...
            <div id="mypage_content">
            	<div id="myprofile">
            		<div id="myprofile_left">
            			...
            			<div id="myname">
            				<span id="my_name">${ loginUser.userName }</span>
            				<span id="my_id">${ loginUser.userId }</span>
            			</div>
            		</div>
            	...
            	<div class="mypage_box" id="delivery_summary">
            		<div id="delivery_title">
						...
						<div id="shopping_more">
            				<a class="more_style">
								더보기
								<svg class=".arr-right-gray" xmlns="http://www.w3.org/2000/svg" width="13px" height="12px" viewBox="0 0 24 24"><path d="M5 3l3.057-3 11.943 12-11.943 12-3.057-3 9-9z"/></svg>
							</a>
						</div>
            		</div>
            			...
            			<div class="interest_product_wrapper">
            				...
            				<c:forEach var="list" items="${wList}">
	            				<div class="interest_products">
	            					...
	            					<span class="mainBrandName">${list.brandName}</span>
	            					<span class="mainProudctName">${list.productName}</span>
	            				</div>
            				</c:forEach>
            				</c:when>
            				<c:otherwise>
